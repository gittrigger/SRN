...
public class August {
	...
	public static String title = "Sea Shepherd";
    public static String dest = "http://www.seashepherd.org/news-and-media/sea-shepherd-news/feed/rss.html";
    public static String dataprovider = "com.ag.seashepherd";
    public static Class lookupClass = com.ag.seashepherd.Lookup.class;
    	
	//Visual
	public static int notifyimage = R.drawable.red;
